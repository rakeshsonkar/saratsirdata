...
/**
 * This is the implementation class for {@link EmployeeService}
 * 
...
public class EmployeeServiceImpl implements EmployeeService {
	...
	/** place holder for the EmployeeRepository */
	@Autowired
	...
	public IFMSResponse getEmployeeById(Integer employeeId) {
		...
		IFMSResponse ifmsResponse = new IFMSResponse(ApiStatus.FAILED, IFMSResponseCode.FAILURE.getCode(),IFMSResponseCode.FAILURE.getMessage());
		...
		if (employeeId != null) {
			...
			ifmsResponse.setResponseCode(IFMSResponseCode.INVALID_DATA.getCode());
			ifmsResponse.setResponseMessage(IFMSResponseCode.INVALID_DATA.getMessage());
			return ifmsResponse;
		}
	...
	public IFMSResponse getEmployeeList() {
		...
		if (employeeList != null && employeeList.size() != 0) {
			...
			ifmsResponse.setData(employeeDTOList);
		} else {
			LOGGER.error("Invalid Data check for null values ");
			return ifmsResponse;
		}
